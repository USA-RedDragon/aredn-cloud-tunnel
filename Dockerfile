FROM ghcr.io/usa-reddragon/aredn-manager:v0.0.116 as aredn-manager
FROM ghcr.io/usa-reddragon/aredn-manager-frontend:v0.0.116 as aredn-manager-frontend
